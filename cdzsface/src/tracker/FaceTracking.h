...
public:
     ...
     * \brief Constructor.
     */
    Tracking(int _max_history_size = 30, double scale = 16.0, std::string algorithm = "MEDIANFLOW");
    ...
    bool track(Mat image, std::vector<Rect> & boundingBox);
...
private:
     ...
     */
    bool add(int object_id, InputArray image, const Rect2d& boundingBox);
