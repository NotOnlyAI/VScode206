...
#ifndef EyeLandmarks_LA1_hpp11
#define EyeLandmarks_LA1_hpp11
...
public:
    ...
    int ForwardBGR(const cv::Mat &image,const M2::Point2f &left_eye,const M2::Point2f &right_eye,M2::LandmarkInfo &landmarkinfo);
